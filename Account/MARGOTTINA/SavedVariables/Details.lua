...
_detalhes_global = {
		...
		["DETAILS_PLUGIN_ENCOUNTER_DETAILS"] = {
			["encounter_timers_bw"] = {
				...
				["194231"] = {
					"Harbaron", -- [1]
					"194231", -- [2]
					"Evocazione: Servitore Incatenato", -- [3]
					8, -- [4]
					636332, -- [5]
					["id"] = 1823,
				},
		...
		["Alitfaier-Pozzo dell'Eternità"] = {
			...
			["chat_tab_embed"] = {
				...
				["w1_pos"] = {
					...
					["point"] = "CENTER",
					["x"] = -391.666381835938,
					["x_legacy"] = -391.666320800781,
					["y_legacy"] = 28.333251953125,
					["w"] = 327.77783203125,
					["pos_table"] = true,
				},
				["single_window"] = false,
			...
			["instances"] = {
				{
					...
					["menu_icons_size"] = 1.10000002384186,
					["switch_all_roles_after_wipe"] = false,
					["wallpaper"] = {
						["enabled"] = false,
						["texcoord"] = {
	...
	["spell_school_cache"] = {
		...
		["Incubo Apocalittico"] = 4,
		["Acque Crescenti"] = 16,
		["Acqua Turbinante"] = 16,
		["Sorgete, Caduti"] = 32,
		["Putrefazione Necrotica"] = 40,
		["Tocco Fatuo"] = 64,
		["Raffica Salmastra"] = 16,
		["Frammentazione"] = 32,
		["Corpo-a-Corpo"] = 1,
		["Assalto Arcano"] = 64,
		["Fuoco Apocalittico"] = 4,
		["Onda di Marea"] = 16,
		["Sabbie Ondeggianti"] = 1,
		["Essenza Contaminata"] = 16,
		["Meteora Fatua"] = 68,
		["Terrore Travolgente"] = 33,
		["Scossa d'Assestamento"] = 1,
		["Perforazione Rapida"] = 1,
		["Strappo Fatuo"] = 32,
		["Detonazione Sputafiele"] = 32,
		["Balzo Atroce"] = 1,
		["Urto Terreno"] = 1,
		["Falce Cosmica"] = 64,
		["Presa Frantumante"] = 8,
